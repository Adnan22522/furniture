										...
										<div class="col-sm-5">
											<div class="single-welcome-hero">
												<div class="welcome-hero-img">
													<img src="{{asset('public/assets/images/slider/slider1.png')}}" alt="slider image">
												</div><!--/.welcome-hero-txt-->
											</div><!--/.single-welcome-hero-->
										</div><!--/.col-->
									</div><!--/.row-->
								...
								<div class="welcome-hero-content">
									<div class="row">
										...
										<div class="col-sm-5">
											<div class="single-welcome-hero">
												<div class="welcome-hero-img">
													<img src="{{asset('public/assets/images/slider/slider2.png')}}" alt="slider image">
												</div><!--/.welcome-hero-txt-->
											</div><!--/.single-welcome-hero-->
										</div><!--/.col-->
									</div><!--/.row-->
								...
								<div class="welcome-hero-content">
									<div class="row">
										...
										<div class="col-sm-5">
											<div class="single-welcome-hero">
												<div class="welcome-hero-img">
													<img src="{{asset('public/assets/images/slider/slider3.png')}}" alt="slider image">
												</div><!--/.welcome-hero-txt-->
											</div><!--/.single-welcome-hero-->
										</div><!--/.col-->
									</div><!--/.row-->
				                ...
				                <ul>
				                    ...
				                    <li class="dropdown">
				                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" >
				                            ...
				                            @if(count($carts)>0)
											<span class="badge badge-bg-1">{{count($carts)}}</span>
											@endif()
				                        </a>
				                        <ul class="dropdown-menu cart-list s-cate">
				                            ...
				                            <li class="single-cart-list">
				                                <a href="#" class="photo"><img src="{{asset('public/images/'.$cart->item['pic'])}}" class="cart-thumb" alt="image" /></a>
				                                <div class="cart-list-txt">
				                                	<h6><a href="#">arm <br> {{$cart->item['name']}}</a></h6>
				                                	<p>1 x - <span class="price">${{$cart->item['sales_price']}}</span></p>
				                                </div><!--/.cart-list-txt-->
				                            ...
				                            @endif()
				                            <li class="single-cart-list">
				                                <a href="#" class="photo"><img src="{{asset('public/assets/images/collection/arrivals2.png')}}" class="cart-thumb" alt="image" /></a>
				                                <div class="cart-list-txt">
				                            ...
				                            <li class="single-cart-list">
				                                <a href="#" class="photo"><img src="{{asset('public/assets/images/collection/arrivals3.png')}}" class="cart-thumb" alt="image" /></a>
				                                <div class="cart-list-txt">
						...
						<div class="col-md-3 col-sm-4">
							<div class="single-new-arrival">
								<div class="single-new-arrival-bg">
									<img src="{{asset('public/images/'.$item->pic)}}" alt="new-arrivals images">
									...
									<div class="new-arrival-cart">
										<p>
											<span class="lnr lnr-cart"></span>
											<a href="{{url('customer/store/add',$item->item_id)}}">add <span>to </span> cart</a>
										</p>
								...
								<p class="arrival-product-price">${{$item->sales_price}}</p>
							</div>
						</div>
						@endforeach()
						@endif()
					...
					<div class="row">
						<div class="col-sm-3">
							<div class="single-feature">
								<img src="{{asset('public/assets/images/features/f1.jpg')}}" alt="feature image">
						...
						<div class="col-sm-3">
							<div class="single-feature">
								<img src="{{asset('public/assets/images/features/f2.jpg')}}" alt="feature image">
								<div class="single-feature-txt text-center">
									<p>
										<i class="fa fa-star"></i>
										<i class="fa fa-star"></i>
						...
						<div class="col-sm-3">
							<div class="single-feature">
								<img src="{{asset('public/assets/images/features/f3.jpg')}}" alt="feature image">
								<div class="single-feature-txt text-center">
									<p>
										<i class="fa fa-star"></i>
										<i class="fa fa-star"></i>
						...
						<div class="col-sm-3">
							<div class="single-feature">
								<img src="{{asset('public/assets/images/features/f4.jpg')}}" alt="feature image">
								<div class="single-feature-txt text-center">
									<p>
										<i class="fa fa-star"></i>
										<i class="fa fa-star"></i>
		...
		<section id="clients"  class="clients">
			<div class="container">
				<div class="owl-carousel owl-theme" id="client">
						<div class="item">
							<a href="#">
								<img src="{{asset('public/assets/images/clients/c1.png')}}" alt="brand-image" />
							</a>
						</div><!--/.item-->
						<div class="item">
							<a href="#">
								<img src="{{asset('public/assets/images/clients/c2.png')}}" alt="brand-image" />
							</a>
						</div><!--/.item-->
						<div class="item">
							<a href="#">
								<img src="{{asset('public/assets/images/clients/c3.png')}}" alt="brand-image" />
							</a>
						</div><!--/.item-->
						<div class="item">
							<a href="#">
								<img src="{{asset('public/assets/images/clients/c4.png')}}" alt="brand-image" />
							</a>
						</div><!--/.item-->
						<div class="item">
							<a href="#">
								<img src="{{asset('public/assets/images/clients/c5.png')}}" alt="brand-image" />
							</a>
						</div><!--/.item-->
					</div><!--/.owl-carousel-->
