@extends('layouts.main')
	...
	@section('table')
	<link rel="stylesheet" href="{{asset('public/style/profile.css')}}">
...
<div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{url('/admin/users')}}" class="nav-link @if(request()->url()==url('/admin/users')) {{'active'}} @endif">Users</a></li>
    ...
    <div class="container emp-profile" style="margin-top: 0px;">
            <form method="post">
                <div class="row">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-6">
                        <div class="profile-head">
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <!-- <li class="nav-item">
                                    <a class="nav-link" id="feedback-tab" data-toggle="tab" href="#feedback" role="tab" aria-controls="profile" aria-selected="false">Feedback</a>
                                </li> -->
                                <li class="nav-item">
							...
							<div class="col-md-offset-1 col-md-10 col-sm-12 main-section">
								...
								<div class="row review-section">
									<div class="col-md-12 col-sm-12 col-xs-12">
										<div class="row">
											<div class="col-md-2 col-md-4 col-xs-4 review-part-left">
												<div class="row">
